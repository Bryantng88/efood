...
INSERT INTO MEAL(name, cost, volume, description, recipe) VALUES('banh xeo', 30000, 40, 'description for test', 'recipe for test');
INSERT INTO MEAL(name, cost, volume, description, recipe) VALUES('banh gai', 25000, 30, 'description for test', 'recipe for test');
INSERT INTO MEAL(name, cost, volume, description, recipe) VALUES('banh u', 35000, 35, 'description for test', 'recipe for test');
INSERT INTO MEAL(name, cost, volume, description, recipe) VALUES('banh hoi', 15000, 40, 'description for test', 'recipe for test');
INSERT INTO MEAL(name, cost, volume, description, recipe) VALUES('banh gio', 30000, 20, 'description for test', 'recipe for test');
INSERT INTO MEAL(name, cost, volume, description, recipe) VALUES('banh chung', 25000, 25, 'description for test', 'recipe for test');
INSERT INTO MEAL(name, cost, volume, description, recipe) VALUES('banh tao lao', 30000, 40, 'description for test', 'recipe for test');
INSERT INTO MEAL(name, cost, volume, description, recipe) VALUES('banh banh', 25000, 40, 'description for test', 'recipe for test');
INSERT INTO MEAL(name, cost, volume, description, recipe) VALUES('banh xe', 30000, 40, 'description for test', 'recipe for test');
