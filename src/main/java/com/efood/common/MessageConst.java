...
public class MessageConst {
	...
	public static final String ERROR_USER_EMAIL_EXISTS = "The email already exists";
	public static final String ERROR_USER_PHONE = "Phone should be number and greater than or equal 10 digitals";
	public static final String ERROR_USER_PASSWORD = "Password is invalid";
	...
	public static final String ERROR_MEAL_EXISTS = "Meal already exists";
	public static final String ERROR_FILE_STORAGE = "File name contains invalid ";

	
	public static final String DOMAIN = "http://localhost:9090/downloadFile/%s";
